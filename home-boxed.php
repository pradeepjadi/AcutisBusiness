...
<body class="brown-bg">
	...
	<header>
		...
		<div class="subheader boxed clearfix">
		...
		<div class="upper-header">
			...
			<div class="logo">
				<a href="#"><img src="images/acutis.png" alt=""></a>
			</div>					
	...
	<div class="wrapper">
		...
		<div class="features dark">
			<div class="features-items column3">
				<a href="#">
					<div class="service-item">
						<a href="#" class="service-img"><img src="images/scope.png" alt=""></a>
					</div>
					<h4>Sthetoscope</h4>
					<div class="line"></div>
			...
			<div class="features-items column3">
				<a href="#">
					<div class="service-item">
						<a href="#" class="service-img"><img src="images/diograph.png" alt=""></a>
					</div>
			...
			<div class="features-items column3">
				<a href="#">
					<div class="service-item">
						<a href="#" class="service-img"><img src="images/care.png" alt=""></a>
					</div>
					<h4>Child Care</h4>
					<div class="line"></div>
					<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis </p>
		...
		<div class="recent-projects">
			...
			<ul class="dark">
				<li class="column3">
					...
					<h4>Proin gravida nibh vel velit auctor aliquet aenean sollicitudin</h4>
